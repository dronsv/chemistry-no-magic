...
const COMPETENCY_IDS = ['oxidation_states'] as const;
...
export default function PracticeSection() {
  ...
  const oxPL = pLevels.get('oxidation_states') ?? 0;
  const mastered = oxPL >= 0.8;
    ...
    <section className="practice-section">
      ...
      {mastered && (
        <div className="practice-section__mastered">
          Отлично! Компетенция на уровне «Уверенный» или выше.
